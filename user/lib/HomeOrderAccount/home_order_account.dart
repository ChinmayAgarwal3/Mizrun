...
class _HomeOrderAccountState extends State<HomeOrderAccount> {
  ...
  List<TabItem> tabItems = List.of([
    new TabItem(Icons.home, "Home", Colors.teal,),
        //labelStyle: TextStyle(fontWeight: FontWeight.normal)),
    new TabItem(Icons.local_offer, "Update", Colors.teal,),
        //labelStyle: TextStyle(color: Colors.red, fontWeight: FontWeight.bold)),
    new TabItem(Icons.reorder, "Order", Colors.teal),
    new TabItem(Icons.account_circle, "Account", Colors.teal),
  ]);
